                            ...
                            <div className="border border-gray-200 rounded-lg overflow-hidden">
                                <table className="min-w-full divide-y divide-gray-200">
                                    <thead className="bg-gray-50">
                                        <tr>
                                            <th className="px-6 py-3 text-left text-xs font-medium text-mpgin-darkBlue uppercase tracking-wider">Sr. No.</th>
                                            <th className="px-6 py-3 text-left text-xs font-medium text-mpgin-darkBlue uppercase tracking-wider">Name of Member</th>
                                            <th className="px-6 py-3 text-left text-xs font-medium text-mpgin-darkBlue uppercase tracking-wider">Designation</th>
                                            <th className="px-6 py-3 text-left text-xs font-medium text-mpgin-darkBlue uppercase tracking-wider">Position</th>
                                        </tr>
                                    </thead>
