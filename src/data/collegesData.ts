  ...
  },
  {
    ...
    departments: [
      ...
      },
      {
        ...
        description:
          "Unique interdisciplinary program focused on textile processing, silk manufacturing, and fiber technology.",
        image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR8-XucgMAGwRzDtHVvol9y1kqZMdYz71baJQ&s",
        courses: [
        ...
        facilities: [
          "Advanced Weaving Labs",
          "Silkworm Rearing Units",
          "Dyeing & Finishing Workshops",
          "Fiber Testing Laboratory",
        ],
        facultyCount: 10,
        gallery: ["/images/silk-tech-1.jpg", "/images/silk-tech-2.jpg"],
      },
      {
        id: "eee2",
        name: "Electrical & Electronics Engineering",
        description:
          "Program integrating electrical systems with cutting-edge electronics and embedded systems.",
        image: "https://snpsu.edu.in/wp-content/uploads/2024/04/ELECTRICAL-AND__.jpg",
        courses: [
          "B.Tech in EEE",
          "Embedded Systems",
          "Digital Electronics",
        ...
        facilities: [
          ...
          "Analog & Digital Circuit Labs",
          "Power Electronics Simulation Center",
          "Microcontroller & FPGA Labs",
        ],
        facultyCount: 15,
        gallery: ["/images/eee2-1.jpg", "/images/eee2-2.jpg"],
      },
    ],
  },
